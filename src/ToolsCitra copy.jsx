...
import { BiCode, BiDownload, BiExport, BiMinus, BiPlus, BiReset, BiRotateLeft, BiSolidImageAdd } from "react-icons/bi";
...
export default function ToolsCitra() {
    ...
    const applyZoom = (value) => {
        const z = Math.max(0.1, Math.min(value, 5)) // 10% – 500%
        setZoom(z)
    ...
    return (
        <div className="bg-langitmalam h-screen w-full p-3 flex flex-col">
            <div className=" flex justify-between items-center px-5 py-1.5 mb-4">
                <span className=" text-neutral-50 text-xl w-[30%]">
                    <span>logo</span>
                ...
                <div className=" flex items-center gap-2 w-[30%] justify-center">
                    <label className="
                        ...
                        hover:bg-white/20
                        transition
                        cursor-pointer text-sm duration-500
                    ">
                    ...
                    <button onClick={resetImage} className={`flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm 
                    text-gray-300 px-3 py-1.5 rounded-lg shadow-sm hover:bg-white/20 transition cursor-pointer
                    text-sm duration-500 ${!hasImage ? "pointer-events-none opacity-50" : ""} `}>
                ...
                <div className=" w-[30%] flex justify-end">
                    <button className={`flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm 
                    text-gray-300 px-3 py-1.5 rounded-lg shadow-sm hover:bg-white/20 transition cursor-pointer
                    text-sm duration-500 ${!hasImage ? "pointer-events-none opacity-50" : ""}
                    `}>
            ...
            <main className=" h-full w-full flex justify-between items-center gap-1.5">
                <div className="w-[78%] h-full flex justify-center items-center relative overflow-hidden">
                    <canvas
                        ref={canvasRef}
                        onWheel={handleWheel}
                        className={`
    ...
    `}
                        >
                            ...
                            <BiSolidImageAdd size={100} className="text-gray-300 mb-5" />
                            <p className="font-medium">
                                Drag and drop an image here, or click to select
                            </p>
                            <p className="font-light text-sm">
                                Supported formats: <span className="font-normal">PNG, JPEG, JPG</span>
                            </p>
                        </label>
                    )}
                ...
                <div className={`w-[22%] h-full bg-transparent shadow-lg shadow-black/20 rounded-xl p-3
                flex flex-col gap-3 ${!hasImage ? "pointer-events-none opacity-50" : ""} `}>
      ...
      hover:bg-white/25
      transition flex items-center justify-evenly
      ">
                        <button
                            onClick={zoomIn}
                        >
                        ...
                        <button
                            ...
                            className="min-w-[70px] text-sm text-center px-2 py-1 rounded hover:bg-white/20"
                        >
                            {Math.round(zoom * 100)}%
                        </button>
                        ...
                        {/* Dropdown */}
                        {showZoomMenu && (
                            <div className="absolute top-full mt-1 left-1/2 -translate-x-1/2 bg-gray-900 rounded shadow-lg z-50">
                                {zoomPresets.map(v => (
                                    <button
                                        key={v}
                                        onClick={() => {
                                        ...
                                        className="block w-full px-4 py-1 text-sm hover:bg-gray-700"
                                    >
                                        {v}%
                                    </button>
                                ))}
